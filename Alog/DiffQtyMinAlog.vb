...
Public Class DiffQtyMinAlog : Implements Alog
            ...
            For j = 1 To maxCNT
                ...
                For Each usemeter As Double In usemeters
                    ...
                    If remainLen >= 0 And remainLen <= allowLen Then
                        ...
                        tempQty = Math.Abs(tempBaseQty - tempOtherBaseQty)
                        tempSave(tempQty, base, otherbase, tempBaseQty, tempOtherBaseQty, i, j, usemeter)
                    End If
    ...
    Private Sub tempSave(diffQty As Integer, base As BaseData, otherbase As BaseData, tempBaseQty As Integer, tempOtherbaseQty As Integer, baseCutCNT As Integer, otherbaseCutCNT As Integer, meter As Double)

        If tempMinQty > diffQty Then
